...
{
    public $name = 'NFS Customizations - SegurosMais';
    public $version = '0.3.0';
    public $authors = 'NFS';
    public $description = 'Customizations exclusive to SegurosMais.';
    ...
    private $defaultConfirmationRedirectUrl = 'https://segurosmais.pt/pagina-subscricao-newsletter-simulacoes/';
